...
namespace Redukti.Nfotopix
{
    ...
    public abstract class Renderer
    {
        ...
        Rgb[] _styles_color = new Rgb[(int)Style.StyleLast];
        ...
        public void draw_polygon(Vector2[] array, Rgb rgb, bool filled, bool closed)
        {
            int i;
        ...
        public void draw_circle(Vector2 v, double r, Rgb rgb, bool filled)
        {
            int count
        ...
        public void draw_triangle(Triangle2 t, bool filled, Rgb rgb)
        {
