...
namespace Redukti.Nfotopix
{
    ...
    public class Asphere : ConicBase
    {
        readonly double _r;        /* radius */
        readonly double _c;        /* curvature = 1/_r */
        readonly double _k;        /* K - eccentricity constant */
        readonly double _A4;       /* deformation polynomial coefficient */
        readonly double _A6;       /* deformation polynomial coefficient */
        readonly double _A8;       /* deformation polynomial coefficient */
        readonly double _A10;      /* deformation polynomial coefficient */
        readonly double _A12;      /* deformation polynomial coefficient */
        readonly double _A14;      /* deformation polynomial coefficient */
        bool _feder_algo = true; /* Use the algorithms by Feder */

        public Asphere(double r, double k, double A4, double A6, double A8, double A10,
                       double A12, double A14) : base(r, k)
        {
        ...
        public Asphere(double r, double k, double A4, double A6, double A8, double A10,
                       double A12, double A14, bool feder_algo) : this(r, k, A4, A6, A8, A10, A12, A14)
        {
