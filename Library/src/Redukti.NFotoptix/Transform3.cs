...
namespace Redukti.Nfotopix
{
    public class Transform3
    {
        ...
        public readonly Matrix3 rotation_matrix;

        /** Whether to use rotation matrix */
        public readonly bool use_rotation_matrix;
        ...
        public Transform3(Vector3 translation, Matrix3 rotation_matrix, bool use_rotation_matrix)
        {
     ...
     */
        ...
        {
            return "{translation=" + this.translation.ToString() + ",rmat=" + this.rotation_matrix + ",use_rmat=" +
                   this.use_rotation_matrix + "}";
        }
    }
}