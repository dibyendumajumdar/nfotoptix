...
namespace Redukti.Nfotopix
{
    public class Abbe : Dielectric
    {
         ...
         */
        public Abbe(AbbeFormula m, double n, double v, double dpgF) : base(m.ToString())
        {
            this._m = m;
            _n = n;
            _v = v;
        ...
        Abbe(AbbeFormula m, double n, double v) : this(m, n, v, 0.0)
        {
        }


        override public double get_measurement_index(double wavelen)
        {
